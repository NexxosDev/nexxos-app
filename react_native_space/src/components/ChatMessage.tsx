...
const styles = StyleSheet.create({
  ...
  bubbleVendor: { backgroundColor: '#FFF8E1', borderBottomRightRadius: 4, borderWidth: 1, borderColor: '#FFE082' },
  bubbleClient: { backgroundColor: '#F5F5F5', borderBottomLeftRadius: 4, borderWidth: 1, borderColor: '#E0E0E0' },
  ...
  quotedText: { fontSize: 12, color: '#616161', lineHeight: 16 },
  text: { fontSize: 15, lineHeight: 20 },
  textVendor: { color: '#212121' },
  textClient: { color: '#212121' },
  time: { fontSize: 10, marginTop: 4, alignSelf: 'flex-end', paddingHorizontal: 4 },
  timeVendor: { color: '#9E9E9E' },
  timeClient: { color: '#9E9E9E' },
