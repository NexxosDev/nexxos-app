...
const styles = StyleSheet.create({
  ...
  readonlyField: { marginBottom: Spacing.md, paddingHorizontal: Spacing.md, paddingVertical: 14, backgroundColor: Colors.backgroundSection, borderRadius: 12 },
  readonlyLabel: { fontSize: 12, color: Colors.textSecondary },
